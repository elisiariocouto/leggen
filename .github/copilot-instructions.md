# Copilot Instructions for Leggen

## Project Overview

Leggen is a self-hosted Open Banking Dashboard, API and CLI for managing bank connections and transactions. It consists of a Python backend (FastAPI + CLI) and a React/TypeScript frontend.
